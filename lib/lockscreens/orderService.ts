...
export async function createLockscreenOrder(input: CreateOrderInput): Promise<CreateOrderResult> {
  ...
  const emailHtml = `
    <div style="font-family:Georgia,'Times New Roman',serif;color:#111417;max-width:520px;">
      ...
      ${quote.needsSalesReview ? `<p style="font-size:13px;color:#a66d00;">This order includes a non-standard screen package or cadence — a Konfydence rep will follow up to confirm final pricing before the licence activates.</p>` : ""}
    </div>
  `;
