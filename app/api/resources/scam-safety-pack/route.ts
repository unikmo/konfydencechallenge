    ...
    const emailSent = await sendBrevoEmail({
      ...
      html: `
        <div style="font-family:Arial,sans-serif;line-height:1.6;color:#111417;max-width:620px;margin:auto;padding:28px">
          ...
          <p style="font-size:16px;color:#5e5a55;margin:0 0 20px">Keep the response simple when a message feels urgent, emotional or threatening: <strong>Pause. Ask. Think.</strong></p>
