...
export default async function LockscreenPurchaseOrderPage({ params }: { params: Promise<{ id: string }> }) {
      ...
      >
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", borderBottom: "2px solid #111417", paddingBottom: 20, marginBottom: 28 }}>
          <div>
            ...
            <div style={{ fontSize: 12, color: "#66645f", marginTop: 4 }}>konfydence.com &middot; Lockscreens for Workplace</div>
          </div>
            ...
            {order.minimumApplied ? (
              <tr style={{ borderBottom: "1px solid rgba(17,20,23,.08)" }}>
                <td style={{ padding: "12px 0" }} colSpan={3}>
                  ...
                  <div style={{ fontSize: 12, color: "#66645f" }}>$300 minimum annual licence applies</div>
                </td>
