...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div style={containerStyle}><div style={contentStyle}>
      ...
      <div style={sectionStyle}><h2 style={headingStyle}>6. Sharing Your Information</h2><p style={paragraphStyle}>We do not sell personal information. We may share information with service providers that help us operate the website, deliver communications, host application data, process consumer payments, provide analytics after consent, or meet legal requirements. Pilot-specific subprocessors and deployment details should be confirmed for the agreed enterprise environment.</p></div>
      ...
      <div style={sectionStyle}><h2 style={headingStyle}>10. Third-Party Links</h2><p style={paragraphStyle}>Our website may contain links to third-party sites. We are not responsible for the privacy practices of external websites. Please review their policies before providing personal information.</p></div>
