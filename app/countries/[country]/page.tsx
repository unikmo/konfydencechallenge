          ...
          <>
            ...
            <section className={styles.section}>
              ...
              <p className={styles.lede}>
                ...
                run <strong>Pause · Think · Call</strong>: stop before you pay, hand over a document or follow someone;
                ask what the request really needs from you; and check on a number or person you already trust.
              </p>
