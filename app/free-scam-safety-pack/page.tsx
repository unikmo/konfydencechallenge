...
export const metadata: Metadata = {
  ...
  description:
    "Download the free Konfydence Emergency Scam Protocol — a printable Pause · Think · Call response sheet for the household.",
  alternates: { canonical: "/free-scam-safety-pack" },
  openGraph: {
    title: "Free Konfydence Emergency Scam Protocol",
    description: "A printable Pause · Think · Call response sheet for the household.",
  ...
  return (
    <PremiumPage ctaHref="#free-scam-safety-pack" ctaLabel="Get the free protocol">
      <div className="k-pack-page-intro k-shell">
        ...
        <p className="k-lede">
          The Emergency Scam Protocol is a free, printable Pause · Think · Call response sheet for when a message,
