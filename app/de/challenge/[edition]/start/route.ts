...
// Only the Familie edition has a German scenario bank so far (Stage 4,
// in progress) — see data/scenarios-de/README.md. The other four editions
// redirect back to the German challenge landing with a "not yet" flag
// rather than silently dropping the player into an English deck.
const GERMAN_EDITIONS = new Set(["family"]);
