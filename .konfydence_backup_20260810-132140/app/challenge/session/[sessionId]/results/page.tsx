        ...
        {isDiagnostic && weakestTrigger ? (
          <div style={styles.conversionCard}>
            ...
            <p style={{ margin: "0 0 14px", fontWeight: 750, lineHeight: 1.55, color: "#dbeafe" }}>
              You have completed a free 8-scenario readiness check. The full challenge gives you 24 balanced scenarios, a deeper pressure-pattern dashboard, and a completion certificate.
            </p>
            ...
            {canPlayAnotherFreeRound ? (
              ...
              <p style={{ margin: "12px 0 0", fontWeight: 850, lineHeight: 1.45, color: "#dbeafe" }}>
                Your two free readiness checks are complete. Unlock the full challenge to keep practising.
              </p>
            )}
