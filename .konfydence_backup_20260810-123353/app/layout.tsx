...
export const metadata: Metadata = {
  ...
  title: {
    default: "Konfydence | Scenario-Based Scam-Readiness Training",
    template: "%s | Konfydence",
  },
  description:
    "Take the free 3-minute TravelSafe travel scam test. Face realistic booking, hotel, taxi, payment and Wi-Fi scams, get your readiness score, and learn your weak spot.",
  openGraph: {
    title: "Would You Spot a Travel Scam Before It Cost You?",
    description:
      "Take the free 3-minute TravelSafe check and discover which scam-pressure tactic is most likely to catch you off guard.",
